...
;(function (a) {
    ...
    E(
        ...
        [a['Core/Color/Color.js'], a['Core/Renderer/SVG/SVGElement.js'], a['Core/Utilities.js']],
        function (a, w, t) {
            var F = a.parse,
                f = t.defined
            a = t.merge
            ...
            x.cuboid = a(x.base, {
                ...
                animate: function (a, d, c) {
                    if (f(a.x) && f(a.y)) {
                        ...
                        b !== this.forcedSides &&
                            ((this.forcedSides = b), x.cuboid.fillSetter.call(this, this.fill))
            ...
            return (function (a) {
                ...
                m.curveTo = function (b, e, h, r, g, y, I, d) {
                    ...
                    return y > g && y - g > Math.PI / 2 + 0.0001
                        ? ((c = c.concat(this.curveTo(b, e, h, r, g, g + Math.PI / 2, I, d))),
                          (c = c.concat(this.curveTo(b, e, h, r, g + Math.PI / 2, y, I, d))))
                ...
                m.prototype.cuboidPath = function (e) {
                    ...
                    var J = function (b, g, e) {
                        ...
                        0 > A(r)
                            ...
                            : 0 > A(c)
                            ? (y = [c, 1])
                            : e && (C.push(e), (y = 0 > A(b) ? [r, 0] : 0 > A(g) ? [c, 1] : [r, 0]))
                        return y
                    }
        ...
        function (a, w, t, D) {
            ...
            ;(function (a) {
                ...
                function q() {
                    ...
                    this.is3d() &&
                        (b.series || []).forEach(function (e) {
                            'scatter' === (e.type || b.chart.type || b.chart.defaultSeriesType) &&
                                (e.type = 'scatter3d')
                        })
                }
                function k() {
                ...
                function t(b) {
                    ...
                    if (this.is3d()) for (; e--; ) (b = this.series[e]), b.translate(), b.render()
                    else b.call(this)
                }
                function w(b) {
        ...
        var t =
            ...
            l = (function (a) {
                ...
                c.prototype.setAxisSize = function () {
                    ...
                    this.width = this.len =
                        (b.options.chart.options3d && b.options.chart.options3d.depth) || 0
                ...
                k = (function () {
                    ...
                    c.prototype.fix3dPosition = function (e, c) {
                        ...
                        var n = z * d.options.chart.options3d.alpha,
                            ...
                            p = b(c && a.options.title.position3d, a.options.labels.position3d)
                    ...
                    c.prototype.swapZ = function (b, a) {
                        var e = this.axis
                        return e.isZAxis
                            ? ((a = a ? 0 : e.chart.plotLeft), { x: a + b.z, y: b.y, z: b.x - a })
                            : b
                    }
                    return c
                })()
    ...
    E(
        ...
        [a['Extensions/Math3D.js'], a['Core/Series/Series.js'], a['Core/Utilities.js']],
        function (a, w, t) {
            var F =
                    (this && this.__extends) ||
                    (function () {
        ...
        function (a, w, t, D, f, z, v) {
            function x(b, a) {
                ...
                c.forEach(function (b) {
                    ...
                    e[d] ? e[d].series.push(b) : ((e[d] = { series: [b], position: f }), f++)
                })
                e.totalStacks = f + 1
                return e
            }
                ...
                'dataLabelsGroup' !== a &&
                    ...
                    k &&
                        (this.chart.columnGroup ||
                            (this.chart.columnGroup = this.chart.renderer.g('columnGroup').add(k)),
            ...
            v(b, 'setVisible', function (b, a) {
                ...
                c.chart.is3d() &&
                    c.data.forEach(function (b) {
                        ...
                        b.graphic && b.graphic.attr({ visibility: a ? 'visible' : 'hidden' })
                    })
        ...
        var w =
            ...
            (function () {
                ...
                return function (f, t) {
                    ...
                    a(f, t)
                    f.prototype =
                        null === t ? Object.create(t) : ((v.prototype = t.prototype), new v())
                }
            })()
    ...
    E(
        ...
        [a['Extensions/Math3D.js'], a['Core/Series/SeriesRegistry.js'], a['Core/Utilities.js']],
        function (a, w, t) {
            var F = a.perspective
            a = w.seriesTypes
            var f = a.line,
