...
;(function (d) {
        ...
        function (d, e, l, a, c) {
            ...
            c = (function () {
                ...
                g.prototype.render = function () {
                    ...
                    if (n)
                        for (
                            n = b(n), g = Math.max(n.length, this.background.length || 0), q = 0;
                            q < g;
                            q++
                        )
                            n[q] && this.axis
                                ? this.renderBackground(x(this.defaultBackgroundOptions, n[q]), q)
                                : this.background[q] &&
                ...
                g.prototype.renderBackground = function (b, g) {
                    ...
                    this.background[g] ||
                        ...
                        (n = 'attr'))
                    this.background[g][n]({ d: this.axis.getPlotBandPath(b.from, b.to, b) }).attr(m)
                }
            ...
            ;(function (a) {
                ...
                function r(h, f, b) {
                    ...
                    if ('polygon' === this.options.gridLineInterpolation)
                        ...
                        z &&
                            ...
                            (n.xBounds =
                                z > -Math.PI / 2 && z < Math.PI / 2 ? [q, r.plotWidth] : [0, q]),
                            (n.yBounds = [a + g[1] + (g[2] / 2) * Math.sin(z)]),
                            (n.yBounds[0] += (z > -Math.PI && 0 > z) || z > Math.PI ? -10 : 10))
                    }
                    return n
                }
                function B(h) {
                ...
                function v(h, f) {
                    ...
                    return this.postTranslate(
                        ...
                        m(this.isCircular ? f : 0 > h ? 0 : h, this.center[2] / 2) - this.offset
                    )
                }
                function E() {
                    var h = this.center,
    ...
    A(
        ...
        [d['Series/Area/AreaSeries.js'], d['Core/Series/Point.js'], d['Core/Utilities.js']],
        function (d, e, l) {
            var a =
                    (this && this.__extends) ||
                    (function () {
                ...
                c.prototype.drawDataLabels = function () {
                    ...
                    if (u) {
                        ...
                        if (v.enabled)
                            for (f = a; f--; )
                                if ((r = g[f]))
                                    r.dataLabels = [r.dataLabelUpper, r.dataLabel].filter(function (
                                        h
                                    ) {
                                        return !!h
                                    })
                    ...
                    b.points.forEach(function (n) {
                        ...
                        'undefined' !== typeof n.plotY &&
                            ...
                            a.styledMode ||
                                ...
                                (I.dashstyle = n.stemDashStyle || g.stemDashStyle || g.dashStyle),
                                n.stem.attr(I),
                                d &&
                                ...
                                v &&
                                    ...
                                    (x.dashstyle = n.boxDashStyle || g.boxDashStyle || g.dashStyle),
                                    n.box.attr(x)),
                                (L.stroke = n.medianColor || g.medianColor || M),
                                (L['stroke-width'] = k(n.medianWidth, g.medianWidth, g.lineWidth)),
                                (L.dashstyle =
        ...
        function (d, e, l, a) {
            ...
            return (function () {
                ...
                a.prototype.renderRange = function (b) {
                    ...
                    'center' === r &&
                        ((u = 0), (a.connectorDistance = 0), (b.labelAttribs.align = 'center'))
                    r = m + a.labels.y
                    ...
                    e.connectors.push(
                        k
                            ...
                            .addClass(
                                (d ? 'highcharts-color-' + this.options.seriesIndex + ' ' : '') +
                ...
                a.prototype.getRanges = function () {
                    ...
                    var l =
                        e === m
                            ? [{ value: m }]
                            : [{ value: e }, { value: (e + m) / 2 }, { value: m, autoRanges: !0 }]
            ...
            ;(function (a) {
                function b(b, a, c) {
                    ...
                    if (
                        ...
                        b.call(this, a, c),
                            f && f.options.enabled && f.bubbleLegend && (f.render(), x(f, m(f)))
                }
                function g(b) {
                    b = b.series
                ...
                function m(b) {
                    ...
                    for (f = 0; f < g; f++)
                        if (
                            (b[f].legendItemHeight && (b[f].itemHeight = b[f].legendItemHeight),
                            b[f] === b[g - 1] ||
                                (b[f + 1] && b[f]._legendItemPos[1] !== b[f + 1]._legendItemPos[1]))
                        ) {
                            a.push({ height: 0 })
                            var u = a[a.length - 1]
                            for (h; h <= f; h++)
            ...
            var a =
                ...
                (function () {
                    ...
                    return function (c, e) {
                        ...
                        a(c, e)
                        c.prototype =
                            null === e ? Object.create(e) : ((k.prototype = e.prototype), new k())
                    }
                })()
            l = l.extend
            e = (function (c) {
                ...
                f.prototype.getRadius = function (b, f, a, g, c, e) {
                    ...
                    if (K(c)) {
                        h.sizeByAbsoluteValue &&
                            ((c = Math.abs(c - u)), (v = Math.max(f - u, Math.abs(b - u))), (b = 0))
                        if (c < b) return a / 2 - 1
                        0 < v && (m = (c - b) / v)
                    }
                    r && 0 <= m && (m = Math.sqrt(m))
                ...
                f.prototype.translateBubble = function () {
                    for (
                        ...
                        var c = b[g],
                            e = f ? f[g] : 0
                        K(e) && e >= a / 2
                            ? ((c.marker = H(c.marker, { radius: e, width: 2 * e, height: 2 * e })),
                              (c.dlBox = {
                                  x: c.plotX - e,
                                  y: c.plotY - e,
                                  width: 2 * e,
                ...
                f.prototype.getZExtremes = function () {
                    ...
                    if (f.length) {
                        var a = y(
                            ...
                            q(
                                n(f),
                                !1 === b.displayNegative ? b.zThreshold || 0 : -Number.MAX_VALUE,
                                Number.MAX_VALUE
                            )
                        )
                        b = y(b.zMax, m(f))
            ...
            var c =
                ...
                (function () {
                    ...
                    return function (a, g) {
                        ...
                        b(a, g)
                        a.prototype =
                            null === g ? Object.create(g) : ((c.prototype = g.prototype), new c())
                    }
                })()
            e = e.noop
            var t = l.seriesTypes,
                ...
                m = a.pick
            a = a.extend
            var n = { pointRange: null, marker: null, states: { hover: { halo: !1 } } }
            t = (function (a) {
                function e() {
                    var b = (null !== a && a.apply(this, arguments)) || this
                    b.data = void 0
    ...
    A(
        ...
        function (d, e, l, a) {
            ...
            a(k.prototype, { pointArrayMap: ['low', 'high'], pointValKey: 'high', doQuartiles: !1 })
                    ...
                    b ||
                        a.points.forEach(function (b) {
                            ...
                            g &&
                                ...
                                g.animate({ rotation: b.shapeArgs.rotation }, a.options.animation))
                        })
                }
            ...
            var a =
                ...
                (function () {
                    ...
                    return function (c, e) {
                        ...
                        a(c, e)
                        c.prototype =
                            null === e ? Object.create(e) : ((d.prototype = e.prototype), new d())
                    }
                })()
            return (function (c) {
                function l() {
        ...
        function (d, e, l) {
            ...
            e.dragNodesMixin = {
                ...
                redrawHalo: function (a) {
                    a &&
                        this.halo &&
                        this.halo.attr({ d: a.haloPath(this.options.states.hover.halo.size) })
                },
            }
            a(d, 'load', function () {
                var c = this,
        ...
        d.networkgraphIntegrations = {
            verlet: {
                ...
                barycenter: function () {
                    ...
                    this.nodes.forEach(function (c) {
                        c.fixedPosition ||
                            ((c.plotX -= d / c.mass / c.degree), (c.plotY -= a / c.mass / c.degree))
                    })
                },
            ...
            euler: {
                ...
                integrate: function (e, d) {
                    ...
                    var a = (d.temperature = e.vectorLength({ x: d.dispX, y: d.dispY }))
                    0 !== a &&
                        ((d.plotX += (d.dispX / a) * Math.min(Math.abs(d.dispX), e.temperature)),
                        (d.plotY += (d.dispY / a) * Math.min(Math.abs(d.dispY), e.temperature)))
                },
                getK: function (e) {
                ...
                updateMassAndCenter: function () {
                    ...
                    this.isInternal
                        ? (this.nodes.forEach(function (d) {
                          ...
                          (e /= a))
                        : this.body &&
                          ((a = this.body.mass), (c = this.body.plotX), (e = this.body.plotY))
                    this.mass = a
                    this.plotX = c
                    this.plotY = e
                },
                ...
                barycenter: function () {
                    ...
                    b.forEach(function (g) {
                        a.options.splitSeries && !g.isParentNode
                            ? ((d = g.series.parentNode.plotX), (m = g.series.parentNode.plotY))
                            : ((d = e.width / 2), (m = e.height / 2))
                        g.fixedPosition ||
                            ((g.plotX -= ((g.plotX - d) * c) / (g.mass * Math.sqrt(b.length))),
                            (g.plotY -= ((g.plotY - m) * c) / (g.mass * Math.sqrt(b.length))))
                    })
                },
                ...
                setCircularPositions: function () {
                    ...
                    e.forEach(function (e, k) {
                        a.options.splitSeries && !e.isParentNode
                            ? ((g = e.series.parentNode.plotX), (d = e.series.parentNode.plotY))
                    ...
                    a.nodes.forEach(function (d) {
                        ...
                        a.nodes.forEach(function (k) {
                            ...
                            d === k ||
                                ...
                                ((b = a.getDistXY(d, k)),
                                (e = a.vectorLength(b) - (d.marker.radius + k.marker.radius + g)),
                                0 > e &&
                                    ((d.degree += 0.01),
                                    d.neighbours++,
                                    (c = a.repulsiveForce(
        ...
        function (d, e, l, a, c) {
            ...
            d = (function (a) {
                ...
                f.prototype.addLayout = function () {
                    ...
                    var d = b[a.type]
                    d ||
                        ((a.enableSimulation = g(c.forExport) ? !c.forExport : a.enableSimulation),
                ...
                f.prototype.calculateParentRadius = function () {
                    ...
                    this.parentNodeRadius = b(
                        ...
                        a
                            ? Math.max(
                                  Math.sqrt(Math.pow(a.width, 2) + Math.pow(a.height, 2)) / 2 + 20,
                                  20
                              )
                            : Math.sqrt((2 * this.parentNodeMass) / Math.PI) + 20
                    )
                ...
                f.prototype.positionBubble = function (a, b, f) {
                    ...
                    e = e(
                        (d(c, 2) + d(f[2] + b[2], 2) - d(f[2] + a[2], 2)) / (2 * (f[2] + b[2]) * c)
                    )
                    h = h(g(a[0] - b[0]) / c)
                    a =
                        (0 > a[1] - b[1] ? 0 : Math.PI) +
                        ...
                        w &&
                            ...
                            l
                                ? ((w = w.connectorThreshold),
                                  (x = Math.round(b.translate(w, 0, 1, 0, 1) + (k ? x : 0)) - e))
    ...
    A(
        ...
        function (d, e, l, a, c, t, p, k, x) {
            ...
            I.getConnectors = function (a, b, c, e) {
                ...
                f = { rightContX: k, rightContY: r, leftContX: h, leftContY: g, plotX: f, plotY: d }
            ...
            var y = function (a, b) {
                ...
                if (d.polar)
                    if (c.isRadialBar)
                        b ||
                            ((c.startAngleRad = q(c.translatedThreshold, c.xAxis.startAngleRad)),
                            ...
                            if (((e = w(e)), c.is('column'))) {
                                ...
                                b
                                    ? ((a = {
                                      ...
                                      f.attr(a),
                                      g && g.attr(a))
                                    : ((a = { translateX: k, translateY: n, scaleX: 1, scaleY: 1 }),
                                      f.animate(a, e),
                                      g && g.animate(a, e))
                    }
                else a.call(this, b)
    ...
    A(
        ...
        [d['Core/Globals.js'], d['Core/Axis/RadialAxis.js'], d['Series/Bubble/BubbleSeries.js']],
        function (d, e, l) {
